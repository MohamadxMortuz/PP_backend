...
class RefreshWorker {
  constructor() {
    ...
    this.intervalMs = config.cache.staleCheckInterval * 1000;
  }
  
  start() {
    console.log(`Starting refresh worker with ${this.intervalMs / 60000} minute interval`);
    this.intervalId = setInterval(() => this.refreshStaleData(), this.intervalMs);
  }
